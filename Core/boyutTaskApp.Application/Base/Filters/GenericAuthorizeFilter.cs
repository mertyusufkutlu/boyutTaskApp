...
public class GenericAuthorizeFilter : IAsyncAuthorizationFilter
{
    ...
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        if (headers.TryGetValue("Authorization", out var headerValues))
        {
            ...
            var existedClaims =
                accessTokenResult.RealmAccess.Roles.Select(r => new Claim("Role", r)).ToList();
            ...
            var newAccessTokenResult =
                new KeyValuePair<object, object>("AccessTokenResult", accessTokenResult);
